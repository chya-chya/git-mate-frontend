        ...
        <div className="p-4 rounded-xl bg-blue-50 border border-blue-100 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-in slide-in-from-top-4 duration-500">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <a 
              ...
              className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 bg-slate-900 text-white rounded-lg hover:bg-black transition-colors"
            >
              <XIcon /> X 공유
            </a>
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 bg-[#0077b5] text-white rounded-lg hover:bg-[#006297] transition-colors"
            >
              <LinkedinIcon /> LinkedIn 공유
            </a>
          </div>
        </div>
      )}
